        ...
        <tr>
            <td style="text-align: center; color: #1e293b;">
                ...
                <div  style="border-radius: 12px;">
                    <img src="https://i.ibb.co/60vWrMJW/Wajha-Logo.jpg" alt="تطبيق وجهة"
                        style="width: 100%;border-radius: 8px;">
                </div>
                <div style="padding: 24px 20px; text-align: center; color: #1e293b;">
                    ...
                    <div
                        ...
                        <p style="margin: 0; color: #ea580c; font-weight: 500; font-size: 13px;">⏰ هذا الرمز سينتهي خلال
                            10
                            دقائق</p>
                    </div>
                    ...
                    <div style="text-align: right; margin-top: 16px;">
                        ...
                        <ul style="padding: 0; margin: 0; list-style: none; text-align: right;">
                            <li style="margin-bottom: 4px; position: relative; padding-right: 16px; font-size: 13px;">
                                <span style="position: absolute; right: 0; color: #2563eb;">•</span> انسخ رمز التحقق
                                أعلاه.
                            </li>
                            <li style="margin-bottom: 4px; position: relative; padding-right: 16px; font-size: 13px;">
